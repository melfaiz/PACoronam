...
private:
    ...
    cellType grid[HEIGHT][WIDTH] = {
        ...
        {EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,TUNNEL,TREAT,EMPTY,EMPTY,EMPTY,RIGHT_BAR,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY,LEFT_BAR,EMPTY,EMPTY,EMPTY,TREAT,TUNNEL,EMPTY,EMPTY,EMPTY,EMPTY,EMPTY},
